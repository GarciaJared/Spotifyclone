...
export const VolumeMute = ({ className }) => (
  <svg data-encore-id="icon"
    fill="currentColor"
    className={className}
    role="presentation" aria-label="Volume off" aria-hidden="false" viewBox="0 0 16 16"
...
export const VolumeHigh = ({ className }) => (
  <svg data-encore-id="icon" fill="currentColor" className={className}
    role="presentation" aria-label="Volume high"
...
export const Volumen = ({ className }) => (
  <svg data-encore-id="icon"
    className={className}
    fill="currentColor"
    role="presentation" aria-label="Volume medium" aria-hidden="false" viewBox="0 0 16 16"
  ><path d="M9.741.85a.75.75 0 0 1 .375.65v13a.75.75 0 0 1-1.125.65l-6.925-4a3.64 3.64 0 0 1-1.33-4.967 3.64 3.64 0 0 1 1.33-1.332l6.925-4a.75.75 0 0 1 .75 0zm-6.924 5.3a2.14 2.14 0 0 0 0 3.7l5.8 3.35V2.8zm8.683 6.087a4.502 4.502 0 0 0 0-8.474v1.65a3 3 0 0 1 0 5.175z"></path></svg>
)
//2:24
  ...
  return (
    <div className="flex justify-center gap-x-2 text-white items-center">
      <button className="opacity-70 hover:opacity-100 transition" onClick={handleClickVolumen}>
        {isVolumeSilenced ? <VolumeMute /> : <Volumen />}
      </button>
      <Slider
        defaultValue={[100]}
        max={100}
